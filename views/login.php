  ...
  <body>
    ...
    <form class="form_container" method="post">
      <div class="logo_container">
        <img src="https://cdn-icons-png.flaticon.com/128/15091/15091085.png" alt="logo.png" class="logoImg">
      </div>
      ...
      <div class="input_container">
        ...
        <input placeholder="Ingrese su nombre de usuario." title="Inpit title" name="usuario" type="text" class="input_field" id="email_field">
      </div>
      <div class="input_container">
        ...
        <input placeholder="Ingrese su contraseña." title="Inpit title" name="password" type="password" class="input_field" id="password_field">
      </div>
